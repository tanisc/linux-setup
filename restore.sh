...
STEPS=(packages_remove packages_apt packages_snap packages_flatpak installers vscode_extensions dotfiles tools_scripts tools_installers winapps ssh_gpg)
